...
Runs may declare a custom metric as a short arithmetic expression over the
prediction/label vectors (e.g. ``"sum(abs(y_true - y_pred)) / len(y_true)"``)
...
def score_metric(spec: str, y_true: Sequence, y_pred: Sequence) -> float:
